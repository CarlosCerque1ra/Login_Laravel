    ...
    <div class="container min-vh-100 d-flex flex-column justify-content-center align-items-center">
        <div class="card shadow p-4" style="max-width: 400px; width: 100%;">
            ...
            <div class="d-flex gap-2 justify-content-center">
                <!-- Botão de Login -->
                <a href="<?php echo e(route('user.login')); ?>" class="btn btn-primary">Login</a>
                <a href="<?php echo e(route('user.cadastro')); ?>" class="btn btn-success">Cadastrar</a>
            </div>
        </div>
    </div>
</body>
...
<?php /**PATH C:\Apache\htdocs\PaginaDeLogin_Laravel\resources\views/welcome.blade.php ENDPATH**/ ?>